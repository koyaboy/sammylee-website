...
const ResponsiveMasonry = lazy(() =>
  import("react-responsive-masonry").then((m) => ({
    default: m.ResponsiveMasonry,
  }))
);
    ...
    <>
      ...
      <div ref={homeRef} className="bg-[#333333] min-h-screen">
        <Header
          ...
          onScrollToDiscography={() => {
            discographyRef.current?.scrollIntoView({ behavior: "smooth" });
          }}
          onScrollToGallery={() => {
        ...
        <main className="px-9">
          ...
          >
            ...
            <div className="aboutText min-[900px]:flex min-[900px]:flex-col min-[900px]:gap-4 min-[900px]:justify-center">
              <div className="flex flex-col items-center gap-3">
                <h2 className="font-rubik font-semibold text-[1.25rem] text-[#F0EAD6] leading-[90%] md:text-[1.75rem] min-[900px]:mr-auto min-[900px]:text-[2.25rem]">
                  About Me
                </h2>
              ...
              <p className="font-inter mt-4 text-[0.813rem] leading-[120%] text-[#CCCCCC] md:text-[1rem] md:px-8 min-[900px]:px-0  min-[900px]:mt-0 min-[900px]:text-[1.05rem]">
                Adewunmi Ayobami Samuel a.k.a SammyLee was born on the 3rd of
                August and brought up in Lagos into the family of Adewunmi.
                <br />
                <br />
                His unique style of music is called Afro-Urban which has sweet
                harmonies, melodies designed to create excitement and fun for
                people to dance. He plays 3 musical instruments such as piano,
                guitar and drum set and he’s also a music producer.
                <br />
                <br />
                SammyLee has collaborated with artistes such as Lil kesh on a
                song titled “wait” and his yet to be released EP featuring Ice
                prince, Mr Eazi, Dj enimoney, Dremo, Skales,D-black and many
                more talented artistes.
              </p>
            </div>
          </div>
          ...
          <div
            ref={discographyRef}
            className="flex flex-col gap-5 mt-8 md:mt-12 min-[900px]:mt-20"
          >
            <div className="flex flex-col items-center gap-3">
              <h2 className="font-rubik font-semibold text-[1.25rem] text-[#F0EAD6] leading-[90%] md:text-[1.75rem] min-[900px]:text-[2.25rem]">
                Discography
              </h2>
            ...
            <p className="hidden text-center w-[55%] ml-auto mr-auto font-inter text-[1rem] text-[#CCCCCC] leading-[120%] md:block lg:text-[1.05rem]">
              Music is an art where creativity can be limitless. I’ve had the
              chance to work with talented artistes across the globe. Take a
              look at some of the the projects and collaborations that I
              personally produced or worked on
            </p>

            <div className="flex flex-col gap-7 md:flex-row md:flex-wrap md:justify-evenly md:px-12">
              <div className="musicPlayer md:w-[45%] md:mt-5">
                <Suspense>
                  <MusicPlayer
                    title={"enjoyment"}
                    src={"tracks/sl-enjoyment.mp3"}
                  />
                </Suspense>
              </div>
              <div className="musicPlayer md:w-[45%] md:mt-5">
            ...
            <div ref={images}>
              <Suspense>
                ...
                >
                  <Masonry gutter="12px">
                    <img
                      src="https://res.cloudinary.com/ds7qm0bwi/image/upload/f_auto,q_auto/v1713033187/SammyLee-Website/sl-two.jpg"
                      alt="SL Image"
                      className="gallery_img w-full h-full"
                      loading="lazy"
                    />
                    <img
                      src="https://res.cloudinary.com/ds7qm0bwi/image/upload/f_auto,q_auto/v1713033187/SammyLee-Website/sl-three.jpg"
                      alt="SL Image"
                      className="gallery_img w-full h-full"
                      loading="lazy"
                    />
                    <img
                      src="https://res.cloudinary.com/ds7qm0bwi/image/upload/f_auto,q_auto/v1713033176/SammyLee-Website/sl-eleven.jpg"
                      alt="SL Image"
                      className="gallery_img w-full h-full"
                      loading="lazy"
                    />
                    <img
                      src="https://res.cloudinary.com/ds7qm0bwi/image/upload/f_auto,q_auto/v1713033177/SammyLee-Website/sl-five.jpg"
                      alt="SL Image"
                      className="gallery_img w-full h-full"
                      loading="lazy"
                    />
                    <img
                      src="https://res.cloudinary.com/ds7qm0bwi/image/upload/f_auto,q_auto/v1713033177/SammyLee-Website/sl-four.jpg"
                      alt="SL Image"
                      className="gallery_img w-full h-full"
                      loading="lazy"
                    />
                    <img
                      src="https://res.cloudinary.com/ds7qm0bwi/image/upload/f_auto,q_auto/v1713033185/SammyLee-Website/sl-thirteen.jpg"
                      alt="SL Image"
                      className="gallery_img w-full h-full"
                      loading="lazy"
                    />
                    <img
                      src="https://res.cloudinary.com/ds7qm0bwi/image/upload/f_auto,q_auto/v1713033183/SammyLee-Website/sl-six.jpg"
                      alt="SL Image"
                      className="gallery_img w-full h-full"
                      loading="lazy"
                    />
                    <img
                      src="https://res.cloudinary.com/ds7qm0bwi/image/upload/f_auto,q_auto/v1713033177/SammyLee-Website/sl-fifteen.jpg"
                      alt="SL Image"
                      className="gallery_img w-full h-full"
                      loading="lazy"
                    />
                    <img
                      src="https://res.cloudinary.com/ds7qm0bwi/image/upload/f_auto,q_auto/v1713033176/SammyLee-Website/sl-eight.jpg"
                      alt="SL Image"
                      className="gallery_img w-full h-full"
                      loading="lazy"
                    />
                    <img
                      src="https://res.cloudinary.com/ds7qm0bwi/image/upload/f_auto,q_auto/v1713033181/SammyLee-Website/sl-seven.jpg"
                      alt="SL Image"
                      className="gallery_img w-full h-full"
                      loading="lazy"
                    />
                    <img
                      src="https://res.cloudinary.com/ds7qm0bwi/image/upload/f_auto,q_auto/v1713033183/SammyLee-Website/sl-ten.jpg"
                      alt="SL Image"
                      className="gallery_img w-full h-full"
                      loading="lazy"
                    />
                    <img
                      src="https://res.cloudinary.com/ds7qm0bwi/image/upload/f_auto,q_auto/v1713033178/SammyLee-Website/sl-nine.jpg"
                      alt="SL Image"
                      className="gallery_img w-full h-full"
                      loading="lazy"
                    />
        ...
        <footer
          ref={contactRef}
          className="bg-[url('/assets/sl-footer-mobile.jpg')] bg-cover bg-no-repeat h-[482px] px-9 py-12 mt-8 sm:h-[500px] min-[900px]:bg-[url('/assets/sl-footer-desktop.jpg')] min-[900px]:h-[420px] bg-center"
        >
          <div className="flex flex-col items-center gap-3 min-[900px]:hidden">
            <h2 className="font-rubik font-semibold text-[1.25rem] text-[#F0EAD6] leading-[90%]">
              Contact Me
            </h2>
          ...
          <div className="w-full min-[900px]:flex min-[900px]:gap-20 min-[900px]:items-center min-[900px]:h-full">
            <form
              ...
              className="mt-8 flex flex-col gap-6 min-[900px]:order-2 w-full"
            >
              <div>
            ...
            <div className="min-[900px]:order-1 min-[900px]:w-[60%]">
              <div className="hidden flex-col gap-2 min-[900px]:flex">
                <h2 className="font-rubik font-semibold text-[2.25rem] text-[#F0EAD6] leading-[90%]">
                  Contact Me
                </h2>
                <hr className="w-[150px] border-2" />
                <p className="font-inter text-[0.95rem] leading-[120%] text-[#F0EAD6] mt-2">
                  {" "}
                  If you'd like to chat, please reach out by filling out the
                  form provided. Alternatively, feel free to contact me via
                  phone or through any of my social media handles.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-6 mt-7">
                ...
                <div className="flex items-center gap-3">
                  ...
                  >
                    <path
                      d="M25.7084 0.833496H5.29169C4.13137 0.833496 3.01857 1.29443 2.19809 2.1149C1.37762 2.93538 0.916687 4.04817 0.916687 5.2085V19.7918C0.916687 20.9522 1.37762 22.0649 2.19809 22.8854C3.01857 23.7059 4.13137 24.1668 5.29169 24.1668H25.7084C26.8687 24.1668 27.9815 23.7059 28.8019 22.8854C29.6224 22.0649 30.0834 20.9522 30.0834 19.7918V5.2085C30.0834 4.04817 29.6224 2.93538 28.8019 2.1149C27.9815 1.29443 26.8687 0.833496 25.7084 0.833496ZM25.7084 3.75016L16.2292 10.2689C16.0075 10.3969 15.756 10.4643 15.5 10.4643C15.244 10.4643 14.9925 10.3969 14.7709 10.2689L5.29169 3.75016H25.7084Z"
                      fill="#F0EAD6"
                    />
                  </svg>

                  <p className="font-inter text-[0.813rem] text-[#F0EAD6] leading-[120%] min-[900px]:text-[1rem]">
                    booksammylee@gmail.com
                  </p>
                </div>

                <div className="flex gap-6">
                  <a
                    href="https://www.instagram.com/officialsammylee?igsh=a3R5aGExYjlhOTNl&utm_source=qr"
                    target="_blank"
                  ...
                  <a
                    href="https://x.com/sammylee_music?s=21"
                    target="_blank"
                    rel="noreferrer noopener"
                  >
                    <svg
                    ...
                    >
                      <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
                        d="M30 30L18.2681 12.5154L18.2881 12.5318L28.8662 0H25.3313L16.7141 10.2L9.87103 0H0.600257L11.5531 16.3241L11.5518 16.3227L0 30H3.5349L13.1152 18.6518L20.7292 30H30ZM8.47042 2.72726L24.9311 27.2727H22.1298L5.65588 2.72726H8.47042Z"
                        fill="#F0EAD6"
                      />
                    </svg>
                  </a>
                  ...
                  <a
                    href="https://www.facebook.com/RealSammyLee?mibextid=LQQJ4d"
                    target="_blank"
                    rel="noreferrer noopener"
                  >
                    <svg
                  ...
                  <a
                    href="https://www.tiktok.com/@sammyleeofficial?_t=8jhwIvcB6tq&_r=1"
                    target="_blank"
                    rel="noreferrer noopener"
                  >
                    <svg
                    ...
                    >
                      <path
                        d="M23.801 4.7C22.4932 3.39937 21.7724 1.72905 21.773 0H15.861V20.6667C15.8154 21.785 15.2733 22.8444 14.349 23.6216C13.4247 24.3988 12.1903 24.8332 10.9056 24.8333C8.18878 24.8333 5.93112 22.9 5.93112 20.5C5.93112 17.6333 9.10714 15.4833 12.3788 16.3667V11.1C5.77806 10.3333 0 14.8 0 20.5C0 26.05 5.28061 30 10.8865 30C16.8941 30 21.773 25.75 21.773 20.5V10.0167C24.1703 11.5164 27.0485 12.3211 30 12.3167V7.16667C30 7.16667 26.4031 7.31667 23.801 4.7Z"
                        fill="#F0EAD6"
                      />
                    </svg>
                  </a>
